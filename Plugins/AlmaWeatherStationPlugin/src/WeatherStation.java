...
/**
 * keeps an array of sensors updating in parallel every refreshTime seconds, and
 * has access to their values through getValue(sensorId, parameterName).
 */
public class WeatherStation {
	 ...
	 */
	private final ScheduledExecutorService schedExSvc = Executors.newScheduledThreadPool(10, r -> {
